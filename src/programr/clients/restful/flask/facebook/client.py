...
from programr.clients.restful.flask.client import FlaskRestBotClient
from programr.clients.restful.flask.facebook.config import FacebookConfiguration
from programr.clients.restful.flask.facebook.renderer import FacebookRenderer
...
class FacebookBotClient(FlaskRestBotClient):
    ...
    def get_description(self):
        return 'ProgramR AIML2.0 Facebook Client'
