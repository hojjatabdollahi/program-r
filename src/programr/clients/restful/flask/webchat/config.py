...
class WebChatConfiguration(RestConfiguration):
    ...
    def __init__(self):
        ...
        self._cookie_id = "ProgramRSession"
    ...
    def load_configuration(self, configuration_file, bot_root):
        ...
        if webchat is not None:
            self._cookie_id = configuration_file.get_option(webchat, "cookie_id", missing_value="ProgramRSession")
    ...
    def to_yaml(self, data, defaults=True):
        if defaults is True:
            data['cookie_id'] = "ProgramRSession"
