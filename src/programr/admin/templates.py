...
brain:
    ...
    services:
        ...
        DuckDuckGo:
            classname: programr.services.duckduckgo.DuckDuckGoService
    ...
    security:
        ...
        authorisation:
            classname: programr.security.authorise.usergroupsauthorisor.BasicUserGroupAuthorisationService
    ...
    dynamic:
        ...
        sets:
            numeric: programr.dynamic.sets.numeric.IsNumeric
...
clear
%s
python3 -m programr.clients.console --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
clear
%s
python3 -m programr.clients.webchat.chatsrv --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
clear
%s
python3 -m programr.clients.rest --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
clear
%s
python3 -m programr.clients.xmpp --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
clear
%s
python3 -m programr.clients.twitter --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
clear
%s
python3 -m programr.clients.socket --config ./config.yaml --cformat yaml --logging ./logging.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.comsole --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.webchat.chatsrv --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.rest --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.xmpp --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.twitter --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
...
mkdir .\temp
%s
python .-m programr.clients.socket --config .\config.windows.yaml --cformat yaml --logging .\logging.windows.yaml
"""
