...
class MapAIMLTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._client_context.brain.properties.load_from_text("""
             default-get:unknown
         """)
        self._client_context.bot.brain.dynamics.add_dynamic_map('romantodec', "programr.dynamic.maps.roman.MapRomanToDecimal", None)
        self._client_context.bot.brain.dynamics.add_dynamic_map('dectoroman', "programr.dynamic.maps.roman.MapDecimalToRoman", None)
