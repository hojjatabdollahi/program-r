...
from programr.clients.events.tcpsocket.client import SocketConnection
from programr.clients.events.tcpsocket.client import SocketBotClient
...
class SocketBotClientTests(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEquals('ProgramR AIML2.0 TCP Socket Client', client.get_description())
    ...
    def test_extract_payload(self):
        ...
        self.assertEquals("Test Question", question)

        userid = client.extract_userid(receive_payload)
        self.assertEquals("user12345", userid)
