...
from programr.clients.polling.telegram.client import TelegramBotClient
from programr.clients.polling.telegram.client import start, message, unknown
from programr.clients.polling.telegram.config import TelegramConfiguration
...
class TelegramBotClientTests(unittest.TestCase):
    ...
    def test_telegram_client_init(self):
        ...
        self.assertEquals('programr AIML2.0 Telegram Client', client.get_description())
