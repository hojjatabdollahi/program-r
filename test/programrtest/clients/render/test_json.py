...
class JSONRendererTests(unittest.TestCase):
    ...
    def test_card(self):
        ...
        self.assertIsNotNone(mock_console._response)
        self.assertEquals({'buttons': [{'postback': None, 'text': 'Hello', 'type': 'button', 'url': 'http://click.me'}], 'image': 'http://servusai.com/aiml.png', 'subtitle': 'Home of programr', 'title': 'Servusai','type': 'card'}, mock_console._response)
    ...
    def test_carousel(self):
        ...
        renderer.render("testuser", "<carousel><card><image>http://servusai.com/aiml.png</image><title>Servusai</title><subtitle>Home of programr</subtitle><button><text>Hello</text><url>http://click.me</url></button></card></carousel>")

        self.assertIsNotNone(mock_console._response)
        self.assertEquals({'cards': [{'buttons': [{'postback': None, 'text': 'Hello', 'type': 'button', 'url': 'http://click.me'}], 'image': 'http://servusai.com/aiml.png', 'subtitle': 'Home of programr', 'title': 'Servusai', 'type': 'card'}],'type': 'carousel'}, mock_console._response)
    ...
    def test_reply_without_postback(self):
        ...
        self.assertIsNotNone(mock_console._response)
        self.assertEquals({'postback': None, 'text': 'Hello', 'type': 'reply'}, mock_console._response)
