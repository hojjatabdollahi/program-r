...
from programr.clients.restful.flask.line.client import LineBotClient
from programr.clients.restful.flask.line.config import LineConfiguration
...
class LineBotClientTests(unittest.TestCase):
    ...
    def test_line_client_init(self):
        ...
        self.assertEquals('programr AIML2.0 Line Client', client.get_description())
