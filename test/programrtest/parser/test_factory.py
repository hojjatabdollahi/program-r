...
class FactoryTests(unittest.TestCase):
    ...
    def test_process_config_line(self):
        ...
        factory.process_config_line("word=programr.parser.pattern.nodes.word.PatternWordNode")
    ...
    def test_load_nodes_config_from_text(self):
        ...
        factory.load_nodes_config_from_text("""
            # Text examples
            root = programr.parser.pattern.nodes.root.PatternRootNode
            word = programr.parser.pattern.nodes.word.PatternWordNode
