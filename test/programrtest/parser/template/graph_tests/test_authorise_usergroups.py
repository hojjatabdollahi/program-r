...
from programr.parser.template.nodes.authorise import TemplateAuthoriseNode
...
class TemplateGraphAuthoriseTests(TemplateGraphTestClient):
    ...
    def get_brain_config(self):
        ...
        brain_config.security.authorisation._classname = "programr.security.authorise.usergroupsauthorisor.BasicUserGroupAuthorisationService"
