...
class TemplateExtensionNodeTests(ParserTestsBaseClass):
    ...
    def test_node_no_data(self):
        ...
        self.assertEqual("programrtest.parser.template.node_tests.test_extension.MockExtension", node.path)
    ...
    def test_node_invalid_class(self):
        root = TemplateNode()
        node = TemplateExtensionNode()
        node.path = "programrtest.parser.template.node_tests.test_extension.MockExtensionOther"
        root.append(node)
    ...
    def test_to_xml(self):
        ...
        self.assertEqual('<template><extension path="programrtest.parser.template.node_tests.test_extension.MockExtension">Test</extension></template>', xml_str)
