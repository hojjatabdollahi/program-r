...
from programr.dialog.dialog import Question, Conversation
...
class TemplateResponseNodeTests(ParserTestsBaseClass):
    ...
    def test_resolve_with_defaults(self):
        ...
        question = Question.create_from_text(self._client_context.brain.nlp.tokenizer, "Hello1 question")
        question.current_sentence()._response = "Hello1 response"
        conversation.record_question(question)

        question = Question.create_from_text(self._client_context.brain.nlp.tokenizer, "Hello quesiton2")
