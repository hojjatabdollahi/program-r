...
class PatternBotNodeTests(ParserTestsBaseClass):
    ...
    def test_init(self):
        ...
        sentence = Sentence(self._client_context.brain.nlp.tokenizer, "value1 value2")
    ...
    def test_equivalent_text(self):
        ...
        match1 = bot1.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'value1'), 0)
        self.assertIsNotNone(match1)
        self.assertTrue(match1.matched)

        match2 = bot2.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'value1'), 0)
        self.assertIsNotNone(match2)
        self.assertTrue(match2.matched)

        match3 = bot3.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'value1'), 0)
