...
class PatternRegexNodeTests(ParserTestsBaseClass):
    ...
    def test_equals_pattern(self):
        ...
        match1 = node1.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'LEGION'), 0)
        self.assertIsNotNone(match1)
        self.assertTrue(match1.matched)

        match2 = node2.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'LEGION'), 0)
        self.assertIsNotNone(match2)
        self.assertTrue(match2.matched)

        match3 = node3.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'LEGION'), 0)
