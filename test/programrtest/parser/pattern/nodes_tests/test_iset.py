...
class PatternSetNodeTests(ParserTestsBaseClass):
    ...
    def test_init(self):
        ...
        sentence = Sentence(self._client_context.brain.nlp.tokenizer, "TEST1 TEST2 TEST3")
    ...
    def test_equals(self):
        ...
        match1 = node1.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'test1'), 0)
        self.assertIsNotNone(match1)
        self.assertTrue(match1.matched)

        match2 = node2.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'test1'), 0)
        self.assertIsNotNone(match2)
        self.assertTrue(match2.matched)

        match3 = node3.equals(self._client_context, Sentence(self._client_context.brain.nlp.tokenizer, 'test1'), 0)
