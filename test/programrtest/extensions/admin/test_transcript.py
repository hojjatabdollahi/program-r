...
from programr.extensions.admin.transcript import TranscriptAdminExtension
...
class TranscriptAdminExtensionTests(unittest.TestCase):
    ...
    def test_transcripts_questions_without_props(self):
        ...
        question = Question.create_from_sentence(Sentence(client_context.brain.nlp.tokenizer, "Hello World"))
