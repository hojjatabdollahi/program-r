...
from programr.extensions.maps.maps import GoogleMapsExtension
from programr.utils.geo.google import GoogleDistance
...
class MapsExtensionTests(unittest.TestCase):
    ...
    def test_format_distance_for_programr(self):
        distance    = os.path.dirname(__file__) +  os.sep + "distance.json"
        ...
        self.assertEquals("DISTANCE DEC 10 FRAC 0 UNITS miles", googlemaps._format_distance_for_programr(distance))

        distance = GoogleDistance("here", "there")
        distance._distance_text = "22.45 km"
        self.assertEquals("DISTANCE DEC 22 FRAC 45 UNITS km", googlemaps._format_distance_for_programr(distance))

    def test_format_directions_for_programr(self):
        directions  = os.path.dirname(__file__) +  os.sep + "directions.json"
        ...
        self.assertEquals("DIRECTIONS Leg As String", googlemaps._format_directions_for_programr(directions))
