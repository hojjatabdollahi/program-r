...
class BrainSecurityConfigurationTests(unittest.TestCase):
    ...
    def test_authorisation_with_data_denied_srai(self):
        ...
        self.assertEqual("programr.security.authorise.passthrough.PassThroughAuthorisationService", service_config.classname)
    ...
    def test_authentication_with_data_denied_srai(self):
        ...
        self.assertEqual("programr.security.authenticate.passthrough.PassThroughAuthenticationService", service_config.classname)
