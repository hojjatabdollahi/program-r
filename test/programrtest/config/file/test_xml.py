...
from programr.config.file.xml_file import XMLConfigurationFile
from programr.clients.events.console.config import ConsoleConfiguration

from programrtest.config.file.base_file_tests import ConfigurationBaseFileTests
...
<root>
	<brain>
		...
		<services>
			<REST>
				<classname>programr.services.rest.GenericRESTService</classname>
				<method>GET</method>
				<host>0.0.0.0</host>
			</REST>
			<Pannous>
				<classname>programr.services.pannous.PannousService</classname>
				<url>http://weannie.pannous.com/api</url>
			</Pannous>
			<Pandora>
				<classname>programr.services.pandora.PandoraService</classname>
				<url>http://www.pandorabots.com/pandora/talk-xml</url>
			</Pandora>
			<Wikipedia>
				<classname>programr.services.wikipediaservice.WikipediaService</classname>
			</Wikipedia>
		</services>
	</brain>
	<bot>
		...
		<spelling>
			<classname>programr.spelling.checker.TestSpellingChecker</classname>
