...
class ConfigurationBaseFileTests(unittest.TestCase):
    ...
    def assert_configuration(self, configuration):
        ...
        self.assertEqual("programr.services.rest.GenericRESTService", rest_config.classname)
        ...
        self.assertEqual(configuration.client_configuration.configurations[0].spelling.classname, "programr.spelling.checker.TestSpellingChecker")
