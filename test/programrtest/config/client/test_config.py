...
class ClientConfigurationDataTests(unittest.TestCase):
    ...
    def test_with_data(self):
        ...
        self.assertEquals("programr.clients.client.DefaultBotSelector", client_config.bot_selector)
        ...
        self.assertEquals("programr.clients.render.text.TextRenderer", client_config.renderer)
