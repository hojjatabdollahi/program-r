...
from programr.bot import DefaultBrainSelector
from programr.bot import BrainFactory
...
class BotTests(unittest.TestCase):
    ...
    def test_bot_init_with_invalid_spellchecker(self):
        ...
        bot_config = BotConfiguration()
        bot_config.spelling._classname = "programr.spelling.checker.SpellingCheckerX"
        bot = Bot(bot_config)
        self.assertIsNotNone(bot)
